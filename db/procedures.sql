...
-- Vista de 3 proyectos en el dashboard
...
INNER JOIN projects.project_image pi
...
-- Llamado de categorías de proyectos en el dashboard
CREATE OR REPLACE FUNCTION projects.get_dashboard_project_categories()
RETURNS TABLE (
    category_id INT,
    name VARCHAR
) AS $$
...
-- Vista de las 5 categorías con más proyectos a su nombre
